...
class PostgresqlStorageEngineProvisionerTest {
    ...
    @Test
    void provision_usesPostgresqlStorageEngineSecurityGroup() {
        ...
        when(postgresqlReplicaConfig.storageEngineSecurityGroupId()).thenReturn("sg-pg-storage-engine");
        ...
        new PostgresqlStorageEngineProvisioner(ec2Client, postgresqlReplicaConfig).provision("name");

        assertThat(postgresqlReplicaConfig.storageEngineSecurityGroupId()).isEqualTo("sg-pg-storage-engine");
    }
}