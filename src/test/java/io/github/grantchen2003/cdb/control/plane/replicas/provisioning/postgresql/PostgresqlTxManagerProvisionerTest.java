...
class PostgresqlTxManagerProvisionerTest {
    ...
    @Test
    void provision_usesPostgresqlTxManagerSecurityGroup() {
        ...
        when(postgresqlReplicaConfig.txManagerSecurityGroupId()).thenReturn("sg-pg-tx-manager");
        ...
        new PostgresqlTxManagerProvisioner(ec2Client, postgresqlReplicaConfig).provision("name");

        assertThat(postgresqlReplicaConfig.txManagerSecurityGroupId()).isEqualTo("sg-pg-tx-manager");
    }
}