...
class RedisTxManagerProvisionerTest {
    ...
    void provision_usesRedisTxManagerSecurityGroup() {
        ...
        when(replicaConfig.redisTxManagerSecurityGroupId()).thenReturn("sg-tx-manager");
        ...
        new RedisTxManagerProvisioner(ec2Client, replicaConfig).provision("name");

        assertThat(replicaConfig.redisTxManagerSecurityGroupId()).isEqualTo("sg-tx-manager");
    }
}